...
rancher_version="${1:-v2.3.0}"; shift || true
rancher_cli_version="${1:-v2.3.0}"; shift || true
k8s_version="${1:-v1.14.7-rancher1-1}"; shift || true
kubectl_version="${1:-1.14.7-00}"; shift # NB execute apt-cache madison kubectl to known the available versions.
